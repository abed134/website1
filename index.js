...
for (let i = 0; i < plansList.length; i++) {
    ...
    numer.iconpackages= plansList[i].numericFeature1;
    rows[3].appendChild(numerultimatetcam);
    
    let numericonpackages = document.createElement("th");
    numericonpackages.textContent = plansList[i].numericFeature2;
    rows[4].appendChild(numericonpackages);
